...
// or post-verbal (not scrambled) pronoun
   ...
   9s2: (CODING col 2 auxv)
      ...
      AND (obl-arg-usable precedes verb-f-all)
   // AWE: There are two copies of 9n1 in order to ensure that * and
   // obl-arg-usable are distinct (i.e. that they are ordered with respect
   // to each other, in either order).  This incorporates a critique made
   // by RZ in his email of 7/25/15
   9n1: (CODING col 2 vf)
      AND (IP* idoms nom-arg-usable)
      AND (IP* idoms verb-f-all)
      AND (nom-arg-usable precedes verb-f-all)

begin_remark: coding RZ IP criteria. 16/07/15 1) included moved objects in IP4. 2) new definitions for subjects (nom-arg|nom-arg-moved) and objects (obl-arg-usable). Latest version 20/07/15.
end_remark
node: IP*
remove_nodes: t
nodes_only: t
...
4: {
   4f: (CODING col 2 auxv|vaux)
      ...
      AND (nom-arg|nom-arg-moved precedes verb-nf-all|IP-INF*)
...
// DP argument; note that DPs with indices are included
   5f: (CODING col 2 vf)
      ...
      AND (nom-arg|nom-arg-moved precedes obl-arg-usable|*PRD*)
